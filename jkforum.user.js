                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (typeof code === 'object') {
                        if (code.error_msg === '服务器内部错误') {
                            ...
                            // 令牌错误不重试
                            new _1.MessageBox('运行错误，请手动重试或联系管理员：' + code.error_msg, 'none', "LOG_POP_GM" /* LOG_POP_GM */);
                            return reject(code);
                        }
                    }
