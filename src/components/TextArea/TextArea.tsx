...
export const TextArea: React.FC<TextAreaProps> = ({ label, placeholder, onChange, value, rows = 3, cols }) => {
  return (
    <>
      ...
      <textarea
        className="px-2 block w-full text-gray-900 bg-gray-50 rounded-lg border sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500"
        id={'textarea' + label}
        rows={rows}
        cols={cols}
