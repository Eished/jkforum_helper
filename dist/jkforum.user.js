                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (typeof code === 'object') {
                        ...
                        if (code.error_code === 100 || code.error_code === 111 || code.error_code === 110) {
                            new _1.MessageBox(code.error_msg + '：令牌错误，需要令牌请登录 jkf.iknow.fun 或发送邮件到 kished@outlook.com ', 'none', "LOG_POP_GM" /* LOG_POP_GM */);
                        }
                        else if (code.error_code === 282000 || code.error_code === 18) {
                            new _1.MessageBox('服务器内部错误，正在重试... ' + code.error_msg);
                            return reject(exports.RETRY);
                        }
                        else {
                            new _1.MessageBox(code.error_msg + ' 未处理的错误，请手动重试或联系管理员', 'none', "LOG_POP_GM" /* LOG_POP_GM */);
                        }
                        return reject(code);
                    }
                    ...
                    if (!response) {
                        new _1.MessageBox(tid + '，无效的帖子ID，请检查帖子状态', 'none');
                    ...
                    if (result === exports.RETRY) {
                        ...
                        new _1.MessageBox(tid + '，无此帖子的访问权限，请检查帖子状态', 'none');
...
function readImage(base64, user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield (0, _1.postData)(user.ocrUrl, body, {
            ...
            var _a;
            // 导致提示信息错误
            return { error_msg: (_a = e.response) === null || _a === void 0 ? void 0 : _a.message, error_code: 999 };
        });
        ...
        try {
            ...
            if (typeof e === 'string') {
                if (e === exports.RETRY) {
                    ...
                    new _1.MessageBox(e, 'none');
                }
            }
            else {
                saveStatusData(t.url, commonType_1.RunStatus.Error);
                new _1.MessageBox(JSON.stringify(e), 'none');
            }
        }
    });
}
