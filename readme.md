...
## 注意：為適配新版捷克論壇，該脚本已遷移至 [JKForum助手瀏覽器擴展](https://github.com/Eished/jkforum_helper_extension) 項目中，新功能將在瀏覽器擴展版中更新，[下載JKForum助手瀏覽器擴展版](https://github.com/Eished/jkforum_helper_extension/releases)
...
- [x] 自动现在有空：
  - [x] 休眠状态唤醒时重复调用时间检测误差增加到 10 分钟，错过点击时间时改为重置点击时间到下一个点击周期
  - [x] 不在运行时间内时，启动时间随机数增加到 120 秒内，减少并发启动时造成的错误重试
- [x] 移除登录时跳过手机验证码功能
